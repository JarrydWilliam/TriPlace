      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <section className="space-y-4 text-sm text-foreground/80 leading-relaxed">
          <div>
            ...
            <p>By using TriPlace, you agree to these Terms of Service. If you do not agree, please do not use the application.</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-2">2. Eligibility</h2>
            <p>You must be at least 13 years of age to use TriPlace. By creating an account, you represent that you meet this requirement.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>TriPlace communities are interest-based groups. Members are expected to engage respectfully. TriPlace reserves the right to remove users or content that violates community standards.</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-2">5. Background Agent</h2>
            <p>TriPlace's background intelligence agent automatically analyzes your activity to update your interest profile and suggest communities. You can view and manage agent-inferred interests in your Settings.</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-2">6. Limitation of Liability</h2>
            <p>TriPlace is provided "as is" without warranties of any kind. We are not liable for damages arising from your use of the service.</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-2">7. Changes</h2>
            <p>We may update these terms at any time. Continued use of TriPlace after changes constitutes acceptance of the new terms.</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-2">8. Contact</h2>
            <p>For questions about these terms, contact <a href="mailto:legal@triplace.app" className="text-primary hover:underline">legal@triplace.app</a></p>
          </div>
        </section>
      </div>
    </div>
